              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <h2 className="text-[15px] font-bold tracking-tight" style={{ color: 'var(--text-primary)' }}>Registered Cards</h2>
                    {isSyncing && (
                  ...
                  <p className="text-[11px] font-medium tracking-wide uppercase" style={{ color: 'var(--text-muted)' }}>{cards.length} of 15 slots used</p>
                </div>
              </div>
              <button
                onClick={onClose}
                  ...
                  {cards.map((card, i) => (
                    ...
                    >
                      ...
                      {editingCard === card.uid ? (
                        ...
                        <div
                          className="group/card relative cursor-pointer w-full"
